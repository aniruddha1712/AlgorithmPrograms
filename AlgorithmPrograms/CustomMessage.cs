...
namespace AlgorithmPrograms
{
    class CustomMessage
    {
        static string message = "Hello <<name>>, We have your full name as <<full name>> in our system.Your contact number" +
            " is 91-xxxxxxxxxx.Please, let us know in case of any clarification Thank you BridgeLabz 01/01/2016 .";
        public static void Pattern()
        {
            string patternName = "^[A-Za-z]*$";
            string patternFullName = "^[A-Za-z ]*[ ][A-Za-z]*$";
            ...
            Console.WriteLine("Enter your Full name (give space between name and surname)");
